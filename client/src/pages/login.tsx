...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    await toast.promise(login(data), {
      pending: "validating your credentails",
            ...
            <div className="md:w-1/1 px-16">
              ...
              <form action="" className="flex flex-col gap-4">
                ...
                <div className="flex flex-row-reverse justify-between">
                  <Link to={"/forgot"} className="text-sm text-blue-600 hover:text-blue-700 pb-2">Forgot Password?</Link>
                </div>
                <button className="bg-blue-500 hover:bg-blue-700 rounded-xl text-white py-2 hover:scale-105 duration-300 disabled:cursor-not-allowed"
                  onClick={handleLogin} disabled={buttonDisable}>Login</button>
              </form>
